// src/components/AnimatedComponents/AnimatedGridBackground.tsx
  ...
  return (
    <>
      ...
      <style>{`
        ...
        :root {
          --grid-line-color: rgba(209, 213, 219, 0.4);
          --fade-color-start: rgba(255, 255, 255, 1);
          --fade-color-end: rgba(255, 255, 255, 0);
        }
        
        .dark {
          --grid-line-color: rgba(75, 85, 99, 0.2);
        }
      `}</style>
      
      <div className="absolute inset-0 overflow-hidden pointer-events-none border-0" style={{ zIndex: 1 }}>
        {/* Vertical Grid Lines */}
        ...
        {/* Top Fade Overlay - Light Mode */}
        <div 
          className="absolute top-0 left-0 right-0 h-32 pointer-events-none dark:hidden"
          style={{
            background: 'linear-gradient(to bottom, var(--fade-color-start), var(--fade-color-end))',
          }}
        />
        ...
        <div 
          ...
          style={{
            background: 'linear-gradient(to top, var(--fade-color-start), var(--fade-color-end))',
          }}
        />
      </div>
    </>
